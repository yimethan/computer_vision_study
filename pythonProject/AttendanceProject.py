...
def findEncodings(images):
    ...
    for img in images:
        ...
        encode = face_recognition.face_encodings(img)[0]        # function purpose
...
while True:
    ...
    imgSmall=cv2.resize(img, (0,0), None, 0.25, 0.25) # 축소 1/4
    ...
    for encodeFace, faceLoc in zip(encodeCurFrame, facesCurFrame):
        matches=face_recognition.compare_faces(encodeListKnown, encodeFace)       # evaluate -> presentation 2w
