- [Convolutional Neural Network](#convolutional-neural-network)
  ...
  - [More edge detection](#more-edge-detection)
    - [Positive edge detection](#positive-edge-detection)
    - [Negative edge detection](#negative-edge-detection)
    - [Horizontal edge detection](#horizontal-edge-detection)
    - [Sobel filter](#sobel-filter)
    - [Scharr filter](#scharr-filter)
  - [Padding](#padding)
...
- [Deep Convolutional Models : Case studies](#deep-convolutional-models--case-studies)
  ...
  - [MobileNet](#mobilenet)
    - [Normal convolution vs Depthwise seperable convolution](#normal-convolution-vs-depthwise-seperable-convolution)
  - [Mobile architecture](#mobile-architecture)
  - [EfficientNet](#efficientnet)
  - [Practical Advice for Using ConvNets](#practical-advice-for-using-convnets)
    - [Transfer learning](#transfer-learning)
    - [Data augmentation](#data-augmentation)
    - [Implementing distortion during training](#implementing-distortion-during-training)
